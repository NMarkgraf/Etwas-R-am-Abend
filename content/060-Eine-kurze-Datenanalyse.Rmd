...
```{r, tidy=TRUE, eval=TRUE, echo=TRUE}
histogram(~total_bill | size, data=tips)
```
...
```{r, tidy=TRUE, eval=TRUE, echo=TRUE}
bwplot(tip ~ sex | smoker, data=tips, main="Trinkgeld nach Rauchern und Geschlecht", ylab="Trinkgeld")
```
...
```{r, tidy=TRUE, eval=TRUE, echo=TRUE}
xyplot(tip~total_bill, data=tips, ylab="Trinkgeld (in USD)", xlab="Rechnungsbetrag (in USD)", main="Trinkgelder in Abhängigkeit vom Rechnungsbetrag")
```
...
```{r, tidy=TRUE, eval=TRUE, echo=TRUE}
xyplot(tip~total_bill, data=tips, ylab="Trinkgeld (in USD)", xlab="Rechnungsbetrag (in USD)", main="Trinkgelder in Abhängigkeit vom Rechnungsbetrag", sub="Daten gruppiert nach dem Geschlecht", groups=sex, auto.key = T)
```
